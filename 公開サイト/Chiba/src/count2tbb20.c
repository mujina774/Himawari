/* count2tbb20.c 
 original made by: Koichi Toyoshima, CEReS CU,
 mod by: Atsushi Higuchi, CEReS CU
 Ver 1.0: original
 Ver 1.1: add the exception for data value of 
 "65535" (01 September 2020) 
*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
/* Output data */
  sprintf(outputfilename,"grid20.dat",argv[1]);
